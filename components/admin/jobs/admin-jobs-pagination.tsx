...
/** Real `<Link>`-based pagination for `/admin/jobs`, mirroring the public site's `JobsPagination`. */
export function AdminJobsPagination({
  ...
  const hrefFor = (targetPage: number) => `/admin/jobs${buildAdminJobsQueryString({ ...filters, page: targetPage })}`;
