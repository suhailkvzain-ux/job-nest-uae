...
/** Real `<Link>`-based pagination for the master-data list pages, mirroring `AdminJobsPagination`. */
export function MasterDataPagination({
  ...
  const hrefFor = (targetPage: number) => `${basePath}${buildMasterDataQueryString({ ...filters, page: targetPage })}`;
