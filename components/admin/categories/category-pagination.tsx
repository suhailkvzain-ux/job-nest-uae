...
/** Pagination for `/admin/categories`, mirroring `MasterDataPagination`/`AdminJobsPagination`. */
export function CategoryPagination({
  filters,
  page,
  totalPages,
}: {
  filters: AdminCategorySearchInput;
  page: number;
  totalPages: number;
}) {
  ...
  const hrefFor = (targetPage: number) =>
    `/admin/categories${buildAdminCategoriesQueryString({ ...filters, page: targetPage })}`;
