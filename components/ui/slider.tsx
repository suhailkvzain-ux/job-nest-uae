...
/** Range slider primitive — powers the Salary Filter (min/max thumbs). */
  ...
  >
    ...
    {(props.value ?? props.defaultValue ?? [0]).map((_, i) => (
      <SliderPrimitive.Thumb
        key={i}
        className={cn(
          "block h-5 w-5 rounded-full border-2 border-primary bg-background shadow-soft transition-transform",
